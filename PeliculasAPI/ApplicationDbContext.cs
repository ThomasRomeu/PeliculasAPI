...
namespace PeliculasAPI
{
    public class ApplicationDbContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            var jimCarrey = new Actor() { Id = 2, Nombre = "Jim Carrey", FechaNacimiento = new DateTime(1962, 01, 17) };
            var robertDowney = new Actor() { Id = 4, Nombre = "Robert Downey Jr.", FechaNacimiento = new DateTime(1965, 4, 4) };
            var chrisEvans = new Actor() { Id = 6, Nombre = "Chris Evans", FechaNacimiento = new DateTime(1981, 06, 13) };
